...
namespace LocalGoods.DAL.Migrations
{
    ...
    [Migration("20221208063622_Final-steps1")]
    partial class Finalsteps1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LocalGoods.DAL.Models.QuantityType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LocalGoods.DAL.Models.Product", b =>
                {
                    b.HasOne("LocalGoods.DAL.Models.Category", "Category")
                        .WithMany("Products")
                    ...
                    b.HasOne("LocalGoods.DAL.Models.QuantityType", "QuantityType")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("LocalGoods.DAL.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
